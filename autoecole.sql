...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 31 mars 2023 à 16:17
...
(113, 'Antipasta', 'Amadeus', 0, '2023-03-04', 'corvisart', '75013', 'Paris', '0123242526'),
...
(158, 'Dec', 'Oskar', 0, '2002-05-17', '177 boulevard Macdonald', '75019', 'Aubervillier', '0783838391');
...
(11, 'Ambrosi', 'Pierre', 0, '2006-01-06', '23, rue du Lycée', '75019', 'Paris', '0180234567'),
...
(1, 'Khalil', 'Tizaoui', 'oskar', 'oskar1', 'eleve', 158, NULL),
...
--
ALTER TABLE `lecon`
  MODIFY `CodeLecon` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;

--
-- AUTO_INCREMENT pour la table `licence`
--
ALTER TABLE `licence`
  MODIFY `CodeLicence` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
